...
import t1708m.fashion.DTO.ProductCategoryDTO;
...
public class CategoryController {
    ...
    public ResponseEntity<Object> store(@RequestBody ProductCategory category) {
        // validate.
        return new ResponseEntity<>(new RESTResponse.Success()
                .setStatus(HttpStatus.CREATED.value())
                .setMessage("Action Success")
                .addData(new ProductCategoryDTO(categoryService.create(category)))
                .build(),
                HttpStatus.CREATED);
    }
    @RequestMapping(method = RequestMethod.PUT, value = "/{id}")
    public ResponseEntity<Object> update(@PathVariable int id, @RequestBody ProductCategory updateCategory) {
        ProductCategory existCategory = categoryService.getById(id);
        ...
        return new ResponseEntity<>(new RESTResponse.Success()
                ...
                .setMessage("Success")
                .addData(new ProductCategoryDTO(categoryService.update(existCategory)))
                .build(),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<Object> getDetail(@PathVariable int id) {
        ...
        return new ResponseEntity<>(new RESTResponse.Success()
                .setStatus(HttpStatus.OK.value())
                .setMessage("Success")
                .addData(new ProductCategoryDTO(categoryService.getById(id)))
                .build(),
                HttpStatus.OK);
    }
